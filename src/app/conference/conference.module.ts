...
import {ConferenceRecentEventsComponent} from '@app/conference/views/_partials/recent-events/conference-recent-events.component';
import {ConferenceAllEventsComponent} from '@app/conference/views/_partials/all-events/conference-all-events.component';
...
@NgModule({
  declarations: [
    ...
    ConferenceRecentEventsComponent,
    ConferenceAllEventsComponent,
