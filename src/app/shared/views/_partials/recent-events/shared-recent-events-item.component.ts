...
@Component({
  selector: 'app-shared-recent-events-item',
  templateUrl: './shared-recent-events-item.component.html',
  styleUrls: ['./shared-recent-events-item.component.scss']
})
export class SharedRecentEventsItemComponent implements OnInit{
  @Input() scope: string;
